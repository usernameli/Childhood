cc.Class({
    ...
    _createObjBlock:function(dataValueObj,dataValueLabel,column,showRowNum,haveShowRow)
    {
        ...
        cc.wwx.OutPut.log("_createObjBlock: ",dataValueObj);
        let objsPrefab = null;
        ...
        if(objsPrefab)
        {
            ...
            cc.wwx.OutPut.log("_createObjBlock1: ",objPrefab);
            cc.wwx.OutPut.log("_createObjBlock2: ",objsComponent);
            ...
            cc.wwx.OutPut.log("_createObjBlock3: ",objsComponent);
