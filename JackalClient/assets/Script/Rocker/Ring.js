var Common = require('./RockerCommon');
...
cc.Class({
    ...
    {
        let posX = Math.cos(this._angle * (Math.PI/180)) * this._speed;
        let posY = Math.sin(this._angle * (Math.PI/180)) * this._speed;
        JackalGlobal.Event.emit("set-pos",{pos:{x:posX,y:posY},angle:this._angle});
