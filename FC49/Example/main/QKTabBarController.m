...
- (void)viewDidLoad {
    ...
    [self setupChildVc:[[HomeViewController alloc] init] title:@"休闲小游戏" image:@"tabBar_home" selectedImage:@"tabBar_home_click" isHiddenNavgationBar:NO];
    [self setupChildVc:[[OrderViewController alloc] init] title:@"飞行游戏" image:@"tabBar_find" selectedImage:@"tabBar_find_click" isHiddenNavgationBar:NO];
    [self setupChildVc:[[NewsViewController alloc] init] title:@"致敬经典" image:@"tabBar_find" selectedImage:@"tabBar_find_click" isHiddenNavgationBar:NO];
    [self setupChildVc:[[MeViewController alloc] init] title:@"猜你喜欢" image:@"tabBar_me" selectedImage:@"tabBar_me_click" isHiddenNavgationBar:NO];
